    ...
    return (
        <section class="about">
            ...
            <div class="about-content">
                <h1>Who we are?</h1>
                <p>Welcome to WellNexa, your destination for premium health and wellness products designed to nourish your body, mind, and soul. At WellNexa, we believe that true wellness is a journey, and we're here to support you every step of the way.</p>
                <p>At WellNexa, our mission is simple: to empower individuals to live healthier, happier lives by providing them with carefully curated products that prioritize quality, efficacy, and sustainability. We believe in the power of nature to heal and nourish, and we're dedicated to sourcing only the finest natural and organic ingredients for our products.</p>
